...
HelpUri: https://github.com/netsec4u/SqlServerTools/blob/main/docs/Reset-SmoServiceMasterKey.md
Locale: en-US
Module Name: SqlServerTools
ms.date: 05/07/2026
PlatyPS schema version: 2024-05-01
title: Reset-SmoServiceMasterKey
---
...
Forcefully regenerate database master key.
 This will cause all secrets that cannot be decrypted by the old service master key to be dropped.
