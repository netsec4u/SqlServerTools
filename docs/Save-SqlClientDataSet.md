...
HelpUri: https://github.com/netsec4u/SqlServerTools/blob/main/docs/Save-SqlClientDataSet.md
Locale: en-US
Module Name: SqlServerTools
ms.date: 05/07/2026
PlatyPS schema version: 2024-05-01
title: Save-SqlClientDataSet
---
...
```yaml
Type: Microsoft.Data.SqlClient.SqlDataAdapter
DefaultValue: None
SupportsWildcards: false
Aliases: []
ParameterSets:
