...
HelpUri: https://github.com/netsec4u/SqlServerTools/blob/main/docs/New-SmoDatabaseUser.md
Locale: en-US
Module Name: SqlServerTools
ms.date: 05/07/2026
PlatyPS schema version: 2024-05-01
title: New-SmoDatabaseUser
---
...
```yaml
Type: Microsoft.SqlServer.Management.Smo.UserType
DefaultValue: None
SupportsWildcards: false
Aliases: []
ParameterSets:
